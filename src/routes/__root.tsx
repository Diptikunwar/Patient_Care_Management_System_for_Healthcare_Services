...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MediCore — Integrated Patient Care Management" },
      { name: "description", content: "Unified admin, physician and patient portal for modern healthcare teams." },
      { property: "og:title", content: "MediCore — Integrated Patient Care Management" },
